...
- [x] High-concurrency Registration Logic (Seat locking).
- [x] Idempotent Payment Flow (Mock).
...
- [ ] AI Summary Integration (Gemini API).
- [ ] Legacy CSV Sync Service.
