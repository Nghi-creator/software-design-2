...
- **Notifications Automated Tests**: Added Vitest coverage for notification storage, registration-triggered in-app notifications, banner auto-read behavior, notification history rendering/read actions, and future-facing channel label formatting.
