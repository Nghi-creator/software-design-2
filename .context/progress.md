...
- **Auth Middleware Tests**: Added `services/api` coverage for header-based user attachment, authentication gating, and RBAC allow/deny behavior in `auth-middleware.test.ts`.
